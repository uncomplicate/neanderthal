...
(ns uncomplicate.neanderthal.mkl-test
  (:require [midje.sweet :refer [facts throws =>]]
            [uncomplicate.neanderthal
             [core :refer [ge tr sy gb tr tb sb sp tp]]
...
(defn test-host [factory]
  ...
  ;;TODO
  (block-test/test-sspar-mat-functor-laws factory sp)
  (block-test/test-sspar-mat-functor-laws factory tp)
  ;; (block-test/test-sspar-mat-functor-laws factory gd)
  ;; (block-test/test-sspar-mat-functor-laws factory gt)
  ;; (block-test/test-sspar-mat-functor-laws factory st)
  )
