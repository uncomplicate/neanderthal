...
* (optional) Add CUDA distribution jars to your project's dependencies (`[org.bytedeco/cuda "12.9-9.10-1.5.13-20250913.041224-9" :classifier "linux-x86_64-redist"]` and `[org.bytedeco/cuda "12.9-9.10-1.5.13-20250913.041224-9" :classifier "linux-x86_64-redist-cublas"]` on Linux, or the same with `windows-*` classifiers on Windows). Please note that you'll have to add Maven Central Snapshots repository (`:repositories [["maven-central-snapshots" "https://central.sonatype.com/repository/maven-snapshots"]]` to your project (this is a temporary requirement, and will be removed soon) since Maven Central introduced hard limit of 2GB, which is exceeded by CUDA's 3GB distribution). MacOS doesn't ship with Nvidia GPUs, thus doesn't support CUDA.
...
Nvidia Toolkit JavaCPP jars (`[org.bytedeco/cuda "12.9-9.10-1.5.13-20250913.041224-9" :classifier "windows-x86_64-redist"]` and `[org.bytedeco/cuda "12.9-9.10-1.5.13-20250913.041224-9" :classifier "windows-x86_64-redist-cublas"]`).
